...
<title>키오스크 <c:out value="${brdMstrVO.bbsNm}" /></title>
					...
					<div class="layout">
						...
						<div class="content_wrap">
							<div id="contents" class="content">
								...
								<p class="txt_1">표준프레임워크센터에서 회원여러분들께 알려드리는 모든 소식을 test.</p>
								...
								<div class="condition">
									...
									<form name="frm" action="<c:url value='/cop/bbs${prefix}/selectBoardList.do'/>" method="post">
										...
										<select name="searchCnd" id="searchCnd" title="검색조건 선택">
												<option value="0" <c:if test="${searchVO.searchCnd == '0'}">selected="selected"</c:if>>제목test1</option>
												<option value="1" <c:if test="${searchVO.searchCnd == '1'}">selected="selected"</c:if>>내용</option>
												<option value="2" <c:if test="${searchVO.searchCnd == '2'}">selected="selected"</c:if>>작성자test3</option>
										</select>
										</label>
